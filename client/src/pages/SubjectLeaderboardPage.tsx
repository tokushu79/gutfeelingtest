...
import { useSubjectLeaderboard } from "../hooks/useLeaderboards";
...
export default function SubjectLeaderboardPage() {
  ...
  const { data, isLoading } = useSubjectLeaderboard(subjectId);
  ...
  return (
    <PageTransition>
      <PageContainer narrow>
        ...
        <h1 className="mb-6 font-display text-2xl font-bold text-white">Subject Leaderboard</h1>
